...
public class BeforeOrderResponse {
    ...
    public String convertWrapperListToString(List<WrapperDto> list) {
    ...
    public String convertBookListToString(List<BeforeOrderBookResponse> list) {
        if (list == null || list.isEmpty()) {
            return "";
        }
        StringBuilder sb = new StringBuilder();
    ...
    public List<WrapperDto> convertStringToWrapperList(String str) {
    ...
    public List<BeforeOrderBookResponse> convertStringToBookList(String str) {
